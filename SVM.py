...
#Retrieving Data
data = pd.read_csv('./data/Ethnicity.csv')
...
param_grid = {
    ...
    'gamma': ['scale', 'auto', 0.1, 1],  # Kernel coefficient (only for 'rbf' kernel)
...
for train_index, val_index in kf.split(X_train, y_train):
    ...
    grid_search = GridSearchCV(svm, param_grid, scoring='neg_mean_squared_error', cv=3)
    ...
    svm_val_pred = best_svm.predict(X_val_enc)

    #Evaluate on validation set (MSE for now to edit/add all my eval methods)
    mse = mean_squared_error(y_train.iloc[val_index], svm_val_pred)
...
###REFERENCES###
#[1]Scikit Learn, “sklearn.svm.SVR — scikit-learn 0.23.1 documentation,” scikit-learn.org. https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVR.html
#[2]M. ANANDITA, “AutoML using SVR and Hyperparameter Optimization,” kaggle.com, 2022. https://www.kaggle.com/code/masayuanandita/automl-using-svr-and-hyperparameter-optimization