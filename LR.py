...
#Models (Includes the ones used for hypertuning)
...
for train_index, val_index in kf.split(X_train, y_train):
    ...
    model_val_pred = best_model_candidate.predict(X_val_enc)

    #Evaluate on validation set (MSE for now to edit/add all my eval methods)
    mse = mean_squared_error(y_train.iloc[val_index], model_val_pred)
...
###REFERENCES###
#[1]scikit-learn developers, “sklearn.linear_model.LinearRegression — scikit-learn 0.22 documentation,” Scikit-learn.org, 2019. https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LinearRegression.html
#[2]Scikit Learn, “1.1. Linear Models — scikit-learn 0.24.0 documentation,” scikit-learn.org. https://scikit-learn.org/stable/modules/linear_model.html